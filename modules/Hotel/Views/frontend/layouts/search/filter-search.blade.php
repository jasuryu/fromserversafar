...
{{--                           readonly="" value="{{$price_range}}">--}}
                        ...
                        <div data-filters-item="pri:pri=1"  style="margin-top: 10px" class=""><input  type="checkbox" name="price_range" class="check" id="check-option-1"
                                                                                                      data-symbol=" {{$currency['symbol'] ?? ''}}"
                                                                            data-min="{{$price_min}}"
                                                                            data-max="{{$price_max}}"
                                                                            data-from="{{$pri_from}}"
                                                                            data-to="{{$pri_to}}"
                                                                            readonly="" value="0;150"><span>0 - 150</span></div>
                        <div data-filters-item="pri:pri=1" style="margin-top: 10px" ><input  type="checkbox" name="price_range" class="check" id="check-option-2"
                                                                                             data-symbol=" {{$currency['symbol'] ?? ''}}"
                                                                            data-min="{{$price_min}}"
                                                                            data-max="{{$price_max}}"
                                                                            data-from="{{$pri_from}}"
                                                                            data-to="{{$pri_to}}"
                                                                            readonly="" value="150;300"><span>150 - 300</span></div>
                        <div data-filters-item="pri:pri=1" style="margin-top: 10px" ><input  type="checkbox" name="price_range " class="check" id="check-option-3"
                                                                                             data-symbol=" {{$currency['symbol'] ?? ''}}"
                                                                            data-min="{{$price_min}}"
                                                                            data-max="{{$price_max}}"
                                                                            data-from="{{$pri_from}}"
                                                                            data-to="{{$pri_to}}"
                                                                            readonly="" value="300;500"><span>300 - 500</span></div>

                        <div data-filters-item="pri:pri=1" style="margin-top: 10px" ><input  type="checkbox" name="price_range" class="check" id="check-option-4"
                                                                                             data-symbol=" {{$currency['symbol'] ?? ''}}"
                                                                            data-min="{{$price_min}}"
                                                                            data-max="{{$price_max}}"
                                                                            data-from="{{$pri_from}}"
                                                                            data-to="{{$pri_to}}"
                                                                            readonly="" value="500;1000000"><span>500  и больше...</span></div>
