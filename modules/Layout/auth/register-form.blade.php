<form class="form bravo-form-register" method="post">
    ...
    <div class="form-group">
        <input type="email" class="form-control" name="email" autocomplete="on" placeholder="{{__('Email address')}}">
    ...
    @endif
    <div class="form-group"><a href="http://newsafar.uz/page/become-a-vendor" > <h5>Стать продавцом</h5></a></div>
